...
function WorkflowFramePreview({
  ...
  return /* @__PURE__ */ import_react.default.createElement("article", { className: `workflow-frame-preview ${file ? "has-file" : ""}` }, /* @__PURE__ */ import_react.default.createElement("p", { className: "eyebrow" }, label), file && isImage(file) ? /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": `\u67E5\u770B${label}`, onClick: () => onPreview(file), type: "button" }, /* @__PURE__ */ import_react.default.createElement("img", { alt: label, src: mediaUrl(file) })) : /* @__PURE__ */ import_react.default.createElement("div", { className: "workflow-frame-empty" }, "\u672A\u9009\u62E9"), /* @__PURE__ */ import_react.default.createElement("strong", { title: file?.name }, file ? displaySelectedVisualName(file.name) : label));
}
...
function GenerationModal({
  ...
  const activePreset = initialPresetId ? availablePresets.find((preset) => preset.id === initialPresetId) : availablePresets.find((preset) => preset.id === presetId) ?? availablePresets[0];
  ...
  const reload = (0, import_react.useCallback)(async () => {
    ...
    try {
      ...
      const next = initialPresetId ? matching.find((preset) => preset.id === initialPresetId) : matching.find((preset) => preset.id === presetId) ?? matching[0];
      if (!next) {
      ...
      setDurationSeconds(initialPresetId === "h3-first-last-video-v1" && initialDurationSeconds ? initialDurationSeconds : String(next.defaults?.durationSeconds ?? 5));
    } catch (reason) {
...
function Workbench({ externalStructureTrigger = false } = {}) {
  ...
  const firstIncompleteShotWorkflowStep = (0, import_react.useMemo)(() => !hasSavedShotBrief ? "design" : !hasShotReference ? "reference" : !hasSelectedFirstFrame ? "firstFrame" : !hasSelectedLastFrame ? "lastFrame" : "video", [hasSavedShotBrief, hasSelectedFirstFrame, hasSelectedLastFrame, hasShotReference]);
  (0, import_react.useEffect)(() => {
  ...
  const openGeneration = async (initialPresetId, skipLeaveDraftCheck = false) => {
    if (!selectedAsset) return;
  ...
  ), /* @__PURE__ */ import_react.default.createElement("div", { className: "topbar-actions" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "refresh-button", disabled: busy || !snapshot, onClick: () => setModal("projectSettings"), type: "button" }, /* @__PURE__ */ import_react.default.createElement("b", null, "\u9879\u76EE\u8BBE\u5B9A")), /* @__PURE__ */ import_react.default.createElement("button", { className: "refresh-button", disabled: busy, onClick: openTrash, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true" }, "\u21BA"), /* @__PURE__ */ import_react.default.createElement("b", null, "\u56DE\u6536\u7AD9")), /* @__PURE__ */ import_react.default.createElement("button", { className: "refresh-button", disabled: loading || busy, onClick: refreshWorkspace, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true" }, "\u21BB"), /* @__PURE__ */ import_react.default.createElement("b", null, loading ? "\u5237\u65B0\u4E2D" : "\u5237\u65B0")))), notice ? /* @__PURE__ */ import_react.default.createElement("div", { "aria-live": "polite", className: `notice notice-${notice.tone}`, role: notice.tone === "error" ? "alert" : "status" }, /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true" }, notice.tone === "success" ? "\u2713" : "!"), notice.text, /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": "\u5173\u95ED\u63D0\u793A", onClick: () => setNotice(null), type: "button" }, "\xD7")) : null, /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-workspace-grid" }, /* @__PURE__ */ import_react.default.createElement("aside", { className: "asset-library-rail" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-rail-heading" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "eyebrow" }, "\u9879\u76EE\u5BFC\u822A"), /* @__PURE__ */ import_react.default.createElement("h1", null, "\u8D44\u4EA7")), /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-tabs", role: "tablist", "aria-label": "\u5236\u4F5C\u4E0E\u8D44\u4EA7\u5E93" }, /* @__PURE__ */ import_react.default.createElement("button", { "aria-controls": "asset-list-panel", "aria-selected": activeTab === "shots", className: `is-primary-tab ${activeTab === "shots" ? "is-active" : ""}`, id: "shots-tab", onClick: () => changeTab("shots"), role: "tab", tabIndex: activeTab === "shots" ? 0 : -1, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u5206\u955C"), /* @__PURE__ */ import_react.default.createElement("b", null, sceneGroups.length)), /* @__PURE__ */ import_react.default.createElement("button", { "aria-controls": "asset-list-panel", "aria-selected": activeTab === "characters", className: activeTab === "characters" ? "is-active" : "", id: "characters-tab", onClick: () => changeTab("characters"), role: "tab", tabIndex: activeTab === "characters" ? 0 : -1, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u4EBA\u7269"), /* @__PURE__ */ import_react.default.createElement("b", null, characterAssets.length)), /* @__PURE__ */ import_react.default.createElement("button", { "aria-controls": "asset-list-panel", "aria-selected": activeTab === "locations", className: activeTab === "locations" ? "is-active" : "", id: "locations-tab", onClick: () => changeTab("locations"), role: "tab", tabIndex: activeTab === "locations" ? 0 : -1, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u5730\u70B9/\u73AF\u5883"), /* @__PURE__ */ import_react.default.createElement("b", null, locationAssets.length)), /* @__PURE__ */ import_react.default.createElement("button", { "aria-controls": "asset-list-panel", "aria-selected": activeTab === "props", className: activeTab === "props" ? "is-active" : "", id: "props-tab", onClick: () => changeTab("props"), role: "tab", tabIndex: activeTab === "props" ? 0 : -1, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u9053\u5177"), /* @__PURE__ */ import_react.default.createElement("b", null, propAssets.length))), activeTab === "shots" ? /* @__PURE__ */ import_react.default.createElement("div", { className: "scene-scope" }, /* @__PURE__ */ import_react.default.createElement(
    SelectField,
    {
      ariaLabel: "\u9009\u62E9\u573A\u6B21",
  ...
  )) : null, /* @__PURE__ */ import_react.default.createElement(WorkflowStepFooter, { disabled: busy, label: "\u4E0B\u4E00\u6B65\uFF1A\u5C3E\u5E27", onClick: () => void advanceShotWorkflow() })) : null, !selectedAsset.isDraft && activeShotWorkflowStep === "lastFrame" ? /* @__PURE__ */ import_react.default.createElement("section", { className: "workflow-step-content" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "workflow-step-heading" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { className: "eyebrow" }, "04 / 05"), /* @__PURE__ */ import_react.default.createElement("h3", null, "\u5C3E\u5E27")), /* @__PURE__ */ import_react.default.createElement("button", { className: "studio-action-button generation-open-button", disabled: busy || !hasSelectedFirstFrame, onClick: () => void openGeneration("shot-last-frame-img2img-v1"), type: "button" }, "\u751F\u6210\u5C3E\u5E27")), /* @__PURE__ */ import_react.default.createElement("div", { className: "workflow-frame-pair is-single" }, /* @__PURE__ */ import_react.default.createElement(WorkflowFramePreview, { file: selectedShotFirstFrame, label: "\u5DF2\u9009\u9996\u5E27", onPreview: setMediaPreview })), selectedShotLastFrameSlot ? /* @__PURE__ */ import_react.default.createElement("div", { className: "workflow-slot" }, /* @__PURE__ */ import_react.default.createElement(
    SlotPanel,
    {
  ...
  )) : null, /* @__PURE__ */ import_react.default.createElement(WorkflowStepFooter, { disabled: busy, label: hasGeneratedShotVideo ? "\u518D\u6B21\u751F\u6210\u56FE\u751F\u89C6\u9891" : "\u63D0\u4EA4\u56FE\u751F\u89C6\u9891", onClick: () => void advanceShotWorkflow() })) : null, selectedAsset.isDraft ? /* @__PURE__ */ import_react.default.createElement("section", { className: "draft-asset-note" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "eyebrow" }, "\u4E0B\u4E00\u6B65"), /* @__PURE__ */ import_react.default.createElement("p", null, "\u5EFA\u7ACB\u955C\u5934\u8D44\u4EA7\u540E\uFF0C\u53EF\u6DFB\u52A0\u53C2\u8003\u56FE\u3001\u9996\u5E27\u3001\u5C3E\u5E27\u548C\u5019\u9009\u8D44\u6599\u3002")) : null)))), mediaPreview ? /* @__PURE__ */ import_react.default.createElement(MediaLightbox, { file: mediaPreview, onClose: () => setMediaPreview(null) }) : null, /* @__PURE__ */ import_react.default.createElement(
