...
function GenerationModal({
  ...
  const [frameMode, setFrameMode] = (0, import_react.useState)(() => frameGeneration?.target === "lastFrame" ? "imageToImage" : "textToImage");
  const [referenceImagePath, setReferenceImagePath] = (0, import_react.useState)(() => frameGeneration?.target === "lastFrame" ? frameGeneration.candidates[0]?.file.path ?? "" : "");
  ...
  const promptInitializationKey = !isVideo2 && activePreset ? [projectId || "", asset.type, assetPath, lookPath || "", activePreset.id].join("\0") : "";
  ...
  const frameModeAvailable = (mode) => !frameGeneration || availablePresets.some((preset) => preset.id === framePresetId(frameGeneration.target, mode));
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-backdrop", onMouseDown: (event) => {
    ...
    return /* @__PURE__ */ import_react.default.createElement(
      "button",
      {
        ...
        key: candidate.key,
        onClick: () => {
          setReferenceImagePath(candidate.file.path);
          setPreview(null);
        },
        type: "button"
      },
      ...
      /* @__PURE__ */ import_react.default.createElement("span", null, /* @__PURE__ */ import_react.default.createElement("strong", { title: candidate.label }, candidate.label), /* @__PURE__ */ import_react.default.createElement("small", null, candidate.detail))
    );
  })) : /* @__PURE__ */ import_react.default.createElement("p", { className: "frame-reference-empty" }, "\u6CA1\u6709\u53EF\u7528\u8F93\u5165\u56FE")) : null) : null, !isVideo2 && activePreset ? /* @__PURE__ */ import_react.default.createElement("section", { className: "generation-section generation-prompt-section" }, /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u63D0\u793A\u8BCD", multiline: true, onChange: (value) => {
    promptEditedRef.current = true;
    setPromptDraft(value);
    setPreview(null);
  }, placeholder: promptLoading ? "\u6B63\u5728\u8BFB\u53D6\uFF0C\u53EF\u76F4\u63A5\u8F93\u5165" : "\u8F93\u5165\u63D0\u793A\u8BCD", value: promptDraft ?? "" }), /* @__PURE__ */ import_react.default.createElement("details", { className: "generation-secondary-prompt" }, /* @__PURE__ */ import_react.default.createElement("summary", null, "\u8D1F\u9762\u63D0\u793A\u8BCD"), /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u8D1F\u9762\u63D0\u793A\u8BCD", multiline: true, onChange: (value) => {
    promptEditedRef.current = true;
    setNegativePromptDraft(value);
    setPreview(null);
  }, placeholder: promptLoading ? "\u6B63\u5728\u8BFB\u53D6\uFF0C\u53EF\u76F4\u63A5\u8F93\u5165" : "\u8F93\u5165\u8D1F\u9762\u63D0\u793A\u8BCD", value: negativePromptDraft ?? "" }))) : null, /* @__PURE__ */ import_react.default.createElement("details", { className: "generation-section generation-options" }, /* @__PURE__ */ import_react.default.createElement("summary", { className: "generation-section-heading" }, /* @__PURE__ */ import_react.default.createElement("strong", null, isVideo2 ? "\u89C6\u9891\u53C2\u6570" : "\u56FE\u7247\u53C2\u6570")), !isVideo2 || hasEditableVideoSpec ? /* @__PURE__ */ import_react.default.createElement("div", { className: `generation-parameter-grid ${isVideo2 ? "is-video" : ""}` }, supportsInput("width") ? /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u5BBD\u5EA6", onChange: setWidth, value: width }) : null, supportsInput("height") ? /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u9AD8\u5EA6", onChange: setHeight, value: height }) : null, supportsInput("denoise") ? /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u91CD\u7ED8\u5F3A\u5EA6", onChange: setDenoise, value: denoise }) : null, supportsInput("durationSeconds") ? /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u65F6\u957F\uFF08\u79D2\uFF09", onChange: setDurationSeconds, value: durationSeconds }) : null, supportsInput("frames") ? /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u5E27\u6570", onChange: setFrames, value: frames }) : null, supportsInput("fps") ? /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u5E27\u7387", onChange: setFps, value: fps }) : null) : null, /* @__PURE__ */ import_react.default.createElement(TextField, { label: "Seed", onChange: setSeed, value: seed })), preview?.errors?.length ? /* @__PURE__ */ import_react.default.createElement("section", { className: "generation-preview has-error" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "generation-result-heading" }, /* @__PURE__ */ import_react.default.createElement("strong", null, "\u65E0\u6CD5\u751F\u6210")), preview.errors.map((item) => /* @__PURE__ */ import_react.default.createElement("p", { className: "generation-preview-error", key: item }, item))) : null, error ? /* @__PURE__ */ import_react.default.createElement("p", { className: "generation-preview-error", role: "alert" }, error) : null, jobs.length ? /* @__PURE__ */ import_react.default.createElement("section", { className: "generation-job-list" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("strong", null, "\u751F\u6210\u8BB0\u5F55")), jobs.slice(0, 4).map((job) => {
...
function Workbench({ externalStructureTrigger = false } = {}) {
  ...
  const frameGenerationCandidates = (target) => {
    ...
    add("\u955C\u5934\u4E13\u5C5E\u53C2\u8003\u56FE", "\u955C\u5934", selectedShotReferenceSlot ? selectedSlotVisual(selectedShotReferenceSlot) : void 0);
    add("\u955C\u5934\u5019\u9009\u56FE", "\u955C\u5934", selectedShotCandidateSlot ? selectedSlotVisual(selectedShotCandidateSlot) : void 0);
    add(activeScene?.sceneId || selectedAsset.design.sceneId, "\u573A\u6B21", activeScene?.scene ? selectedVisualFromAsset(activeScene.scene, ["setting", "reference", "firstFrame", "lastFrame"]) : void 0);
    for (const location of effectiveLocationAssetsForSelectedShot) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("main", { className: "workbench-shell" }, /* @__PURE__ */ import_react.default.createElement("header", { className: "topbar" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "brand-lockup" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "brand-sigil", "aria-hidden": "true" }, /* @__PURE__ */ import_react.default.createElement("i", null), /* @__PURE__ */ import_react.default.createElement("i", null), /* @__PURE__ */ import_react.default.createElement("i", null)), /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { className: "brand-name" }, "\u6F2B\u5267\u5DE5\u4F5C\u53F0"))), /* @__PURE__ */ import_react.default.createElement(
    ...
    event.currentTarget.closest("details")?.removeAttribute("open");
    refreshWorkspace();
  }, type: "button" }, loading ? "\u5237\u65B0\u4E2D" : "\u5237\u65B0")))), notice ? /* @__PURE__ */ import_react.default.createElement("div", { "aria-live": "polite", className: `notice notice-${notice.tone}`, role: notice.tone === "error" ? "alert" : "status" }, /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true" }, notice.tone === "success" ? "\u2713" : "!"), notice.text, /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": "\u5173\u95ED\u63D0\u793A", onClick: () => setNotice(null), type: "button" }, "\xD7")) : null, /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-workspace-grid" }, /* @__PURE__ */ import_react.default.createElement("aside", { className: "asset-library-rail" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-rail-heading" }, /* @__PURE__ */ import_react.default.createElement("h1", null, "\u8D44\u4EA7")), /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-tabs", role: "tablist", "aria-label": "\u5206\u955C\u4E0E\u8D44\u4EA7\u5E93" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-nav-group" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "asset-nav-group-label" }, "\u5236\u4F5C"), /* @__PURE__ */ import_react.default.createElement("button", { "aria-controls": "asset-list-panel", "aria-selected": activeTab === "shots", className: `is-primary-tab ${activeTab === "shots" ? "is-active" : ""}`, id: "shots-tab", onClick: () => changeTab("shots"), role: "tab", tabIndex: activeTab === "shots" ? 0 : -1, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u5206\u955C"), /* @__PURE__ */ import_react.default.createElement("b", null, sceneGroups.length))), /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-nav-group" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "asset-nav-group-label" }, "\u8D44\u4EA7\u5E93"), /* @__PURE__ */ import_react.default.createElement("button", { "aria-controls": "asset-list-panel", "aria-selected": activeTab === "characters", className: activeTab === "characters" ? "is-active" : "", id: "characters-tab", onClick: () => changeTab("characters"), role: "tab", tabIndex: activeTab === "characters" ? 0 : -1, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u4EBA\u7269"), /* @__PURE__ */ import_react.default.createElement("b", null, characterAssets.length)), /* @__PURE__ */ import_react.default.createElement("button", { "aria-controls": "asset-list-panel", "aria-selected": activeTab === "locations", className: activeTab === "locations" ? "is-active" : "", id: "locations-tab", onClick: () => changeTab("locations"), role: "tab", tabIndex: activeTab === "locations" ? 0 : -1, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u573A\u666F"), /* @__PURE__ */ import_react.default.createElement("b", null, locationAssets.length)), /* @__PURE__ */ import_react.default.createElement("button", { "aria-controls": "asset-list-panel", "aria-selected": activeTab === "props", className: activeTab === "props" ? "is-active" : "", id: "props-tab", onClick: () => changeTab("props"), role: "tab", tabIndex: activeTab === "props" ? 0 : -1, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u9053\u5177"), /* @__PURE__ */ import_react.default.createElement("b", null, propAssets.length)))), activeTab === "shots" ? /* @__PURE__ */ import_react.default.createElement("div", { className: "scene-scope" }, /* @__PURE__ */ import_react.default.createElement(
    SelectField,
    {
      ariaLabel: "\u9009\u62E9\u573A\u6B21",
  ...
  )) : null, /* @__PURE__ */ import_react.default.createElement(WorkflowStepFooter, { disabled: busy, label: "\u4E0B\u4E00\u6B65\uFF1A\u5C3E\u5E27", onClick: () => void advanceShotWorkflow() })) : null, !selectedAsset.isDraft && activeShotWorkflowStep === "lastFrame" ? /* @__PURE__ */ import_react.default.createElement("section", { className: "workflow-step-content" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "workflow-step-heading" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h3", null, "\u5C3E\u5E27")), /* @__PURE__ */ import_react.default.createElement("button", { className: "studio-action-button generation-open-button", disabled: busy || !hasSelectedFirstFrame, onClick: () => void openFrameGeneration("lastFrame"), type: "button" }, "\u751F\u6210\u5C3E\u5E27")), /* @__PURE__ */ import_react.default.createElement("div", { className: "workflow-frame-pair is-single" }, /* @__PURE__ */ import_react.default.createElement(WorkflowFramePreview, { file: selectedShotFirstFrame, label: "\u5DF2\u9009\u9996\u5E27", onPreview: setMediaPreview })), selectedShotLastFrameSlot ? /* @__PURE__ */ import_react.default.createElement("div", { className: "workflow-slot" }, /* @__PURE__ */ import_react.default.createElement(
    SlotPanel,
    {
