...
function StoryboardWorkflow({
  ...
  return /* @__PURE__ */ import_react.default.createElement("nav", { "aria-label": "\u5206\u955C\u5236\u4F5C\u6D41\u7A0B", className: "storyboard-workflow" }, nodes.map((node, index) => /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, { key: node.label }, /* @__PURE__ */ import_react.default.createElement("button", { className: `storyboard-workflow-node is-${node.state}`, onClick: () => onSelect(index), type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "storyboard-workflow-index" }, node.state === "done" ? "\u2713" : String(index + 1).padStart(2, "0")), /* @__PURE__ */ import_react.default.createElement("span", null, node.label)), index < nodes.length - 1 ? /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true", className: `storyboard-workflow-line ${node.state === "done" ? "is-done" : ""}` }) : null)));
}
function SlotPanel({
  slot,
  disabled,
...
function Workbench({ externalStructureTrigger = false } = {}) {
  ...
  const storyboardWorkflow = (0, import_react.useMemo)(() => {
  ...
  ), activeScene ? /* @__PURE__ */ import_react.default.createElement("small", null, sceneGroups.length, " \u573A \xB7 \u5F53\u524D ", activeScene.shots.length, " \u955C\u5934", activeScene.draftCount ? ` \xB7 ${activeScene.draftCount} \u5F85\u5BFC\u5165` : "") : /* @__PURE__ */ import_react.default.createElement("small", null, "\u8FD8\u6CA1\u6709\u53EF\u7528\u573A\u6B21")) : null, activeTab === "shots" ? /* @__PURE__ */ import_react.default.createElement(StoryboardWorkflow, { nodes: storyboardWorkflow, onSelect: (index) => {
    if (index === 0) {
