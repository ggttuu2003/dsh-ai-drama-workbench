...
var SELECTABLE_VISUAL_SLOTS = /* @__PURE__ */ new Set(["turnaround", "setting", "firstFrame", "lastFrame", "candidate"]);
...
function SceneAssetCard({
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    ...
    /* @__PURE__ */ import_react.default.createElement("span", { className: "scene-asset-card-copy" }, /* @__PURE__ */ import_react.default.createElement("strong", null, scene.sceneId), /* @__PURE__ */ import_react.default.createElement("em", null, scene.shotCount, " \u4E2A\u5206\u955C"))
  );
}
...
function ShotWorkflowStepper({
  ...
  return /* @__PURE__ */ import_react.default.createElement("nav", { "aria-label": "\u5F53\u524D\u5206\u955C\u5236\u4F5C\u6D41\u7A0B", className: "storyboard-stepper" }, nodes.map((node, index) => /* @__PURE__ */ import_react.default.createElement(
    "button",
    {
...
function AssemblyPage({
  ...
  return /* @__PURE__ */ import_react.default.createElement("section", { "aria-labelledby": "assembly-title", className: "assembly-page", id: "assembly-panel" }, /* @__PURE__ */ import_react.default.createElement("header", { className: "assembly-page-heading" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { className: "eyebrow" }, "\u6210\u7247"), /* @__PURE__ */ import_react.default.createElement("h3", { id: "assembly-title" }, "\u5206\u955C\u89C6\u9891 ", readyCount, "/", shots.length)), /* @__PURE__ */ import_react.default.createElement("div", { className: "assembly-page-actions" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "text-button", disabled: busy || loading, onClick: onRefresh, type: "button" }, "\u5237\u65B0"), /* @__PURE__ */ import_react.default.createElement("button", { className: "submit-button", disabled: !canMerge, onClick: onMerge, type: "button" }, "\u5408\u5E76\u6210\u7247"))), error ? /* @__PURE__ */ import_react.default.createElement("div", { className: "assembly-error", role: "alert" }, error) : null, loading && !data ? /* @__PURE__ */ import_react.default.createElement("div", { className: "assembly-empty" }, "\u6B63\u5728\u8BFB\u53D6\u5206\u955C\u89C6\u9891\u2026") : shots.length ? /* @__PURE__ */ import_react.default.createElement("div", { className: "assembly-shot-list" }, shots.map((shot, index) => {
  ...
  })) : /* @__PURE__ */ import_react.default.createElement("div", { className: "assembly-empty" }, "\u5B8C\u6210\u5206\u955C\u89C6\u9891\u540E\u53EF\u5408\u5E76"), missingCount > 0 ? /* @__PURE__ */ import_react.default.createElement("p", { className: "assembly-missing-count" }, "\u7F3A\u5C11 ", missingCount, " \u4E2A\u5206\u955C\u89C6\u9891") : null, data?.outputs?.length ? /* @__PURE__ */ import_react.default.createElement("section", { className: "assembly-history", "aria-label": "\u5386\u53F2\u603B\u7247" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "assembly-history-heading" }, /* @__PURE__ */ import_react.default.createElement("strong", null, "\u5386\u53F2\u603B\u7247"), /* @__PURE__ */ import_react.default.createElement("small", null, data.outputs.length)), /* @__PURE__ */ import_react.default.createElement("div", { className: "assembly-history-list" }, data.outputs.map((file) => /* @__PURE__ */ import_react.default.createElement("article", { className: "assembly-history-item", key: file.path }, /* @__PURE__ */ import_react.default.createElement("video", { controls: true, playsInline: true, preload: "none", src: mediaUrl(file) }), /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("strong", { title: file.name }, file.name), /* @__PURE__ */ import_react.default.createElement("small", null, formatTimestamp(file.updatedAt), " \xB7 ", formatSize(file.size))))))) : null);
}
function SlotPanel({
  slot,
  disabled,
...
function ProfilePreview({ content }) {
  ...
  for (const line of content.split(/\r?\n/)) {
    ...
    if (heading) {
      ...
      const headingTitle = heading[2].replace(/[：:]\s*$/u, "").trim().toLocaleLowerCase("zh-Hans-CN");
...
function DraftSummary({ design }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("section", { className: "draft-summary", "aria-label": "\u5206\u955C\u8349\u7A3F\u6458\u8981" }, /* @__PURE__ */ import_react.default.createElement("dl", { className: "draft-summary-grid" }, items.map(([label, value]) => /* @__PURE__ */ import_react.default.createElement("div", { className: "draft-summary-item", key: label }, /* @__PURE__ */ import_react.default.createElement("dt", null, label), /* @__PURE__ */ import_react.default.createElement("dd", null, value || "\u672A\u586B\u5199")))), /* @__PURE__ */ import_react.default.createElement("div", { className: "draft-summary-block" }, /* @__PURE__ */ import_react.default.createElement("h4", null, "\u753B\u9762\u63CF\u8FF0"), /* @__PURE__ */ import_react.default.createElement("p", null, design.content || "\u672A\u586B\u5199")), /* @__PURE__ */ import_react.default.createElement("div", { className: "draft-summary-block" }, /* @__PURE__ */ import_react.default.createElement("h4", null, "\u53F0\u8BCD"), /* @__PURE__ */ import_react.default.createElement("p", null, design.dialogue || "\u65E0\u53F0\u8BCD")), /* @__PURE__ */ import_react.default.createElement("div", { className: "draft-summary-block" }, /* @__PURE__ */ import_react.default.createElement("h4", null, "\u8FD0\u955C"), /* @__PURE__ */ import_react.default.createElement("p", null, design.camera || "\u672A\u586B\u5199")));
}
...
function GenerationModal({
  ...
  const [modelsError, setModelsError] = (0, import_react.useState)(null);
  const [loadedModelContext, setLoadedModelContext] = (0, import_react.useState)("");
  ...
  const modelContextKey = activePreset && activeProfileId ? `${activeProfileId}\0${activePreset.id}` : "";
  ...
  (0, import_react.useEffect)(() => {
    ...
    void request(`/models?profileId=${encodeURIComponent(activeProfileId)}&presetId=${encodeURIComponent(activePreset.id)}`).then((response) => {
      if (cancelled) return;
      const available = response.models.filter((model) => model.available);
      setModels(available);
      setModelId((current) => available.some((model) => model.id === current) ? current : available.find((model) => model.id === response.defaultModelId)?.id ?? available[0]?.id ?? "");
  ...
  if (!assetPath) {
    return /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-backdrop" }, /* @__PURE__ */ import_react.default.createElement("section", { "aria-modal": "true", className: "modal-card generation-modal", role: "dialog" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-heading" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h2", null, "\u8BF7\u5148\u65B0\u5EFA\u5206\u955C")), /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": "\u5173\u95ED", className: "icon-button", onClick: onClose, type: "button" }, "\xD7")), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-actions" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "text-button", onClick: onClose, type: "button" }, "\u77E5\u9053\u4E86"))));
  }
  const canSubmit = Boolean(
    activePreset && profileReady && modelReady && (!isFrameImageToImage || referenceImagePaths.length > 0)
  );
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-backdrop", onMouseDown: (event) => {
    if (event.target === event.currentTarget) onClose();
  } }, /* @__PURE__ */ import_react.default.createElement("section", { "aria-labelledby": "generation-modal-title", "aria-modal": "true", className: "modal-card generation-modal", role: "dialog" }, /* @__PURE__ */ import_react.default.createElement("header", { className: "modal-heading generation-modal-heading" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h2", { id: "generation-modal-title" }, displayWorkspaceAssetTitle(asset))), /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": "\u5173\u95ED", className: "icon-button", onClick: onClose, type: "button" }, "\xD7")), /* @__PURE__ */ import_react.default.createElement("div", { className: "generation-modal-body" }, loading ? /* @__PURE__ */ import_react.default.createElement("p", { className: "generation-loading" }, "\u6B63\u5728\u8BFB\u53D6\u751F\u6210\u8BBE\u7F6E\u2026") : /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("section", { className: "generation-section generation-task-settings" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "generation-form-grid" }, /* @__PURE__ */ import_react.default.createElement(SelectField, { ariaLabel: "\u9009\u62E9 ComfyUI \u670D\u52A1\u5668", label: "\u670D\u52A1\u5668", onChange: (value) => void chooseProfile(value), options: profiles.map((profile) => ({ label: `${profile.name}${profile.configured && profile.enabled ? "" : " \xB7 \u672A\u914D\u7F6E"}`, value: profile.id })), value: activeProfileId }), isVideo2 ? /* @__PURE__ */ import_react.default.createElement("div", { className: "generation-fixed-preset" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u89C6\u9891"), /* @__PURE__ */ import_react.default.createElement("strong", null, activePreset?.label || "\u4E0D\u53EF\u7528")) : modelsLoading ? /* @__PURE__ */ import_react.default.createElement("div", { className: "generation-fixed-preset" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u6A21\u578B"), /* @__PURE__ */ import_react.default.createElement("strong", null, "\u8BFB\u53D6\u4E2D\u2026")) : selectedModel && models.length > 1 ? /* @__PURE__ */ import_react.default.createElement(SelectField, { ariaLabel: "\u9009\u62E9\u751F\u6210\u6A21\u578B", label: "\u6A21\u578B", onChange: chooseModel, options: models.map((model) => ({ label: model.label, value: model.id })), value: selectedModel.id }) : /* @__PURE__ */ import_react.default.createElement("div", { className: "generation-fixed-preset" }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u6A21\u578B"), /* @__PURE__ */ import_react.default.createElement("strong", null, selectedModel?.label || (!profileReady ? "\u5148\u8FDE\u63A5\u670D\u52A1\u5668" : modelsError || "\u6B64\u65B9\u5F0F\u6682\u65E0\u53EF\u7528\u6A21\u578B"))))), frameGeneration ? /* @__PURE__ */ import_react.default.createElement("section", { className: "generation-section frame-generation-section" }, /* @__PURE__ */ import_react.default.createElement("div", { "aria-label": `${frameGenerationLabel(frameGeneration.target)}\u751F\u6210\u65B9\u5F0F`, className: "frame-generation-mode-toggle", role: "group" }, /* @__PURE__ */ import_react.default.createElement("button", { "aria-pressed": frameMode === "textToImage", disabled: !frameModeAvailable("textToImage"), onClick: () => chooseFrameMode("textToImage"), type: "button" }, "\u6587\u751F\u56FE"), /* @__PURE__ */ import_react.default.createElement("button", { "aria-pressed": frameMode === "imageToImage", disabled: !frameModeAvailable("imageToImage"), onClick: () => chooseFrameMode("imageToImage"), type: "button" }, "\u53C2\u8003\u751F\u56FE")), isFrameImageToImage ? /* @__PURE__ */ import_react.default.createElement("div", { className: "frame-reference-picker" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "frame-reference-picker-heading" }, /* @__PURE__ */ import_react.default.createElement("strong", null, supportsMultipleReferences ? "\u53C2\u8003\u56FE" : "\u8F93\u5165\u56FE"), /* @__PURE__ */ import_react.default.createElement("small", null, referenceImagePaths.length, "/", maxReferenceImages)), frameGeneration.candidates.length ? /* @__PURE__ */ import_react.default.createElement("div", { className: "frame-reference-grid" }, frameGeneration.candidates.map((candidate) => {
...
function Workbench({ externalStructureTrigger = false } = {}) {
    ...
    for (const override of designDraft.characterOverrides ?? []) {
      ...
      if (override.mode === "inherit") {
        ...
        effective.set(override.characterPath, {
          ...
          sourceLabel: override.state ? "\u573A\u6B21\u9ED8\u8BA4 \xB7 \u672C\u5206\u955C\u72B6\u6001" : inherited.sourceLabel
        });
        continue;
      }
      effective.set(override.characterPath, {
        ...
        sourceLabel: override.mode === "look" ? "\u672C\u5206\u955C \xB7 \u8986\u76D6\u9020\u578B" : "\u672C\u5206\u955C \xB7 \u8EAB\u4EFD\u57FA\u51C6"
      });
    }
  ...
  const hasSelectedCharacterReference = effectiveCastForSelectedShot.some((entry) => {
    ...
    return Boolean(
      look?.confirmedVisuals.turnaround ?? character?.confirmedVisuals.turnaround
    );
  });
  const selectedShotReferenceVisuals = (0, import_react.useMemo)(() => {
    ...
    for (const entry of effectiveCastForSelectedShot) {
      const character = characterByPath.get(entry.characterPath);
      const look = getLookForPath(character, entry.lookPath);
      const file = look?.confirmedVisuals.turnaround ?? character?.confirmedVisuals.turnaround;
      if (file) addVisual({
  ...
  const sceneAssetGenerationCandidates = (targetAsset) => {
    ...
    const addCharacter = (character) => {
      ...
      for (const look of character.looks) {
        addAssetImages(look, ["turnaround"], `${character.name} \xB7 ${look.name}`, "\u4EBA\u7269", "characterReference");
      }
    };
  ...
  const savedSceneDraft = selectedAsset?.type === "scene" ? normalizeLegacySceneDocumentTitle(selectedAsset.sceneContent || "", selectedAsset.sceneId) : "";
  ...
  const isDirty = (0, import_react.useMemo)(() => {
    ...
    if (selectedAsset.type === "scene") {
      return hasUnsavedSceneDocument || JSON.stringify(sceneCastDraft) !== JSON.stringify(selectedAsset.castBindings) || hasUnsavedSceneAssetBindings || hasUnsavedProjectSettingsDraft;
    }
  ...
  const handleTrashAsset = async () => {
    if (!selectedAsset) return;
    const assetLabel = selectedAsset.type === "character" ? selectedAsset.name : selectedAsset.type === "location" || selectedAsset.type === "prop" ? selectedAsset.name : selectedAsset.type === "scene" ? `${selectedAsset.sceneId} \u573A\u6B21\u53CA\u5176\u5168\u90E8\u5206\u955C` : selectedAsset.design.shotId;
  ...
  return /* @__PURE__ */ import_react.default.createElement("main", { className: "workbench-shell" }, /* @__PURE__ */ import_react.default.createElement("header", { className: "topbar" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "brand-lockup" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "brand-sigil", "aria-hidden": "true" }, /* @__PURE__ */ import_react.default.createElement("i", null), /* @__PURE__ */ import_react.default.createElement("i", null), /* @__PURE__ */ import_react.default.createElement("i", null)), /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { className: "brand-name" }, "\u6F2B\u5267\u5DE5\u4F5C\u53F0"))), /* @__PURE__ */ import_react.default.createElement(
    ...
    SelectField,
    {
      ...
      options: sceneGroups.map((scene) => ({ label: `${scene.sceneId} \xB7 ${scene.shots.length} \u5206\u955C`, value: scene.sceneId })),
      value: activeScene?.sceneId || ""
    }
  )) : null, /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-list-tools" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-search" }, /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true" }, "\u2315"), /* @__PURE__ */ import_react.default.createElement("input", { "aria-label": activeTab === "characters" ? "\u641C\u7D22\u4EBA\u7269" : activeTab === "locations" ? "\u641C\u7D22\u573A\u666F" : activeTab === "props" ? "\u641C\u7D22\u9053\u5177" : "\u641C\u7D22\u5F53\u524D\u573A\u6B21\u5206\u955C", onChange: (event) => changeSearch(event.target.value), placeholder: activeTab === "characters" ? "\u641C\u7D22\u4EBA\u7269" : activeTab === "locations" ? "\u641C\u7D22\u573A\u666F" : activeTab === "props" ? "\u641C\u7D22\u9053\u5177" : "\u641C\u7D22\u5F53\u524D\u573A\u6B21\u5206\u955C", value: search }), search ? /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": "\u6E05\u7A7A\u641C\u7D22", className: "asset-search-clear", onClick: () => changeSearch(""), type: "button" }, "\xD7") : null), activeTab === "characters" || activeTab === "locations" || activeTab === "props" ? /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": "\u65B0\u5EFA\u8D44\u4EA7", className: "add-asset-button", onClick: openCreate, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true" }, "\uFF0B"), /* @__PURE__ */ import_react.default.createElement("b", null, "\u65B0\u5EFA")) : /* @__PURE__ */ import_react.default.createElement("div", { className: "scene-create-actions" }, /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": "\u65B0\u5EFA\u573A\u6B21", className: "add-asset-button is-secondary", onClick: openCreateScene, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true" }, "\uFF0B"), /* @__PURE__ */ import_react.default.createElement("b", null, "\u573A\u6B21")), /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": "\u65B0\u5EFA\u5206\u955C", className: "add-asset-button", onClick: openCreate, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true" }, "\uFF0B"), /* @__PURE__ */ import_react.default.createElement("b", null, "\u5206\u955C")))), activeTab === "shots" ? /* @__PURE__ */ import_react.default.createElement("button", { className: "import-storyboard-button", disabled: busy || !activeDraftGroups.length, onClick: openStoryboardImport, type: "button" }, /* @__PURE__ */ import_react.default.createElement("span", { "aria-hidden": "true" }, "\u21E3"), "\u5BFC\u5165\u5F53\u524D\u573A\u6B21\u5267\u672C", activeDraftGroups.length ? /* @__PURE__ */ import_react.default.createElement("b", null, activeDraftGroups.reduce((total, group) => total + group.shots.length, 0)) : null) : null, activeTab === "shots" && activeScene?.scene ? /* @__PURE__ */ import_react.default.createElement("div", { className: "scene-asset-summary" }, /* @__PURE__ */ import_react.default.createElement(SceneAssetCard, { active: assetKey(activeScene.scene) === selectedKey, onClick: () => selectAsset(assetKey(activeScene.scene)), scene: activeScene.scene })) : activeTab === "shots" && activeScene ? /* @__PURE__ */ import_react.default.createElement("button", { className: "scene-asset-create-note", disabled: busy, onClick: () => void handleCreateScene(activeScene.sceneId), type: "button" }, /* @__PURE__ */ import_react.default.createElement("b", null, "\u5B8C\u5584\u573A\u6B21")) : null, /* @__PURE__ */ import_react.default.createElement("div", { "aria-labelledby": `${activeTab}-tab`, className: "asset-card-list", id: "asset-list-panel", role: "tabpanel" }, loading ? /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-list-empty" }, "\u6B63\u5728\u6574\u7406\u8D44\u4EA7\u2026") : snapshot?.error ? /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-list-empty error-copy" }, snapshot.error) : visibleAssets.length ? visibleAssets.map((asset) => /* @__PURE__ */ import_react.default.createElement(AssetCard, { active: assetKey(asset) === selectedKey, asset, key: assetKey(asset), onClick: () => selectAsset(assetKey(asset)), sceneReferenceCount: asset.type === "location" || asset.type === "prop" ? sceneReferenceCounts.get(asset.rootPath) : void 0 })) : /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-list-empty" }, /* @__PURE__ */ import_react.default.createElement("strong", null, search ? "\u6CA1\u6709\u5339\u914D\u8D44\u4EA7" : activeTab === "characters" ? "\u8FD8\u6CA1\u6709\u4EBA\u7269" : activeTab === "locations" ? "\u8FD8\u6CA1\u6709\u573A\u666F" : activeTab === "props" ? "\u8FD8\u6CA1\u6709\u9053\u5177" : "\u5F53\u524D\u573A\u6B21\u8FD8\u6CA1\u6709\u5206\u955C")))) : null), /* @__PURE__ */ import_react.default.createElement("section", { className: "asset-studio-column" }, /* @__PURE__ */ import_react.default.createElement("div", { className: `asset-studio-head asset-studio-toolbar ${activeTab === "assembly" ? "is-assembly-studio" : ""} ${selectedAsset?.type === "character" ? "is-character-studio" : ""} ${selectedAsset?.type === "scene" ? "is-scene-studio" : ""}` }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { className: "asset-breadcrumb" }, activeTab === "assembly" ? "\u5206\u955C\u5236\u4F5C / \u6210\u7247" : selectedAsset?.type === "location" ? "\u8D44\u4EA7\u5E93 / \u573A\u666F" : selectedAsset?.type === "prop" ? "\u8D44\u4EA7\u5E93 / \u9053\u5177" : activeTab === "characters" ? selectedAsset?.type === "character" ? `\u8D44\u4EA7\u5E93 / \u4EBA\u7269 / ${selectedAsset.roleCategory}` : "\u8D44\u4EA7\u5E93 / \u4EBA\u7269" : activeScene ? `\u5206\u955C\u5236\u4F5C / \u573A\u6B21 / ${activeScene.sceneId}` : "\u5206\u955C\u5236\u4F5C"), /* @__PURE__ */ import_react.default.createElement("div", { className: "asset-title-row" }, /* @__PURE__ */ import_react.default.createElement("h2", null, activeTab === "assembly" ? "\u6210\u7247" : selectedAsset ? displayWorkspaceAssetTitle(selectedAsset) : "\u9009\u62E9\u8D44\u4EA7"), activeTab !== "assembly" && selectedAsset?.type === "character" ? /* @__PURE__ */ import_react.default.createElement(
    "span",
    {
    ...
    return /* @__PURE__ */ import_react.default.createElement("article", { className: "shot-character-override", key: `${override.characterPath}-${index}` }, /* @__PURE__ */ import_react.default.createElement("div", { className: "scene-cast-row-head" }, /* @__PURE__ */ import_react.default.createElement("strong", null, "\u5206\u955C\u8986\u76D6 ", String(index + 1).padStart(2, "0")), /* @__PURE__ */ import_react.default.createElement("button", { "aria-label": `\u79FB\u9664\u7B2C ${index + 1} \u6761\u5206\u955C\u4EBA\u7269\u8986\u76D6`, className: "asset-file-remove", disabled: busy, onClick: () => removeShotCharacterOverride(index), type: "button" }, "\xD7")), /* @__PURE__ */ import_react.default.createElement("div", { className: "scene-cast-row-grid" }, /* @__PURE__ */ import_react.default.createElement(SelectField, { ariaLabel: `\u9009\u62E9\u7B2C ${index + 1} \u6761\u955C\u5934\u8986\u76D6\u4EBA\u7269`, label: "\u4EBA\u7269", disabled: busy || !characterAssets.length, onChange: (characterPath) => updateShotCharacterOverride(index, { characterPath, mode: inheritedSceneCastForSelectedShot.some((binding) => binding.characterPath === characterPath) ? "inherit" : "identity", lookPath: void 0 }), options: characterAssets.map((asset) => ({ label: `${asset.name} \xB7 ${asset.roleCategory}`, value: asset.rootPath })), value: override.characterPath }), /* @__PURE__ */ import_react.default.createElement(SelectField, { ariaLabel: `\u9009\u62E9${character?.name || "\u4EBA\u7269"}\u5728\u672C\u5206\u955C\u7684\u9020\u578B`, label: "\u672C\u5206\u955C\u9020\u578B", disabled: busy || !appearanceOptions.length, onChange: (value) => updateShotCharacterOverride(index, value === "__inherit__" ? { mode: "inherit", lookPath: void 0 } : value === "__identity__" ? { mode: "identity", lookPath: void 0 } : { mode: "look", lookPath: value }), options: appearanceOptions, value: appearanceValue }), /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u5C40\u90E8\u72B6\u6001", onChange: (state) => updateShotCharacterOverride(index, { state }), placeholder: "\u5982\uFF1A\u6CBE\u7070\u3001\u7709\u5FC3\u7EA2\u7EBF\u6E05\u6670", value: override.state })));
  })) : null, effectiveCastForSelectedShot.length ? /* @__PURE__ */ import_react.default.createElement("div", { className: "shot-effective-cast", "aria-label": "\u672C\u5206\u955C\u6700\u7EC8\u751F\u6548\u7684\u4EBA\u7269\u4E0E\u9020\u578B" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "shot-effective-cast-heading" }, /* @__PURE__ */ import_react.default.createElement("strong", null, "\u6700\u7EC8\u751F\u6548\u7684\u4EBA\u7269\u4E0E\u9020\u578B")), /* @__PURE__ */ import_react.default.createElement("div", { className: "shot-inherited-cast" }, effectiveCastForSelectedShot.map((entry) => {
    const character = characterByPath.get(entry.characterPath);
    const look = getLookForPath(character, entry.lookPath);
    const preview = look?.confirmedVisuals.turnaround ?? character?.confirmedVisuals.turnaround;
...
function SshSettings({ connection, error, busy, syncing, onClose, onSave, onStart, onStop, onSync }) {
  ...
  const start = () => {
    try {
      onStart({ ...draft, ...password ? { password } : {} });
    } finally {
      setPassword("");
    }
  };
