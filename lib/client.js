...
function GenerationModal({
  ...
  const [referenceImagePaths, setReferenceImagePaths] = (0, import_react.useState)(() => {
    const initial = frameGeneration?.target === "lastFrame" ? frameGeneration.candidates.find((candidate) => candidate.role === "firstFrame")?.file.path : void 0;
  ...
  const requiredFirstFramePath = frameGeneration?.target === "lastFrame" ? frameGeneration.candidates.find((candidate) => candidate.role === "firstFrame")?.file.path ?? "" : "";
  const requiresTailFirstFrame = frameGeneration?.target === "lastFrame" && frameMode === "imageToImage";
  const hasRequiredFirstFrame = !requiresTailFirstFrame || Boolean(requiredFirstFramePath && referenceImagePaths.includes(requiredFirstFramePath));
  ...
  const canSubmit = Boolean(
    activePreset && profileReady && (!isFrameImageToImage || referenceImagePaths.length > 0 && hasRequiredFirstFrame)
  );
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-backdrop", onMouseDown: (event) => {
    ...
    return /* @__PURE__ */ import_react.default.createElement(
      "button",
      {
        ...
        title: requiredFirstFrame ? "\u5C3E\u5E27\u4EE5\u5DF2\u9009\u9996\u5E27\u4E3A\u57FA\u51C6\uFF0C\u4E0D\u80FD\u53D6\u6D88" : void 0,
        type: "button"
      },
  ...
  })) : /* @__PURE__ */ import_react.default.createElement("p", { className: "frame-reference-empty" }, "\u6CA1\u6709\u53EF\u7528\u8F93\u5165\u56FE"), frameGeneration.target === "lastFrame" && isFrameImageToImage && !hasRequiredFirstFrame ? /* @__PURE__ */ import_react.default.createElement("p", { className: "generation-inline-error" }, "\u5C3E\u5E27\u5FC5\u987B\u5305\u542B\u5DF2\u9009\u9996\u5E27\uFF0C\u8BF7\u5237\u65B0\u540E\u91CD\u65B0\u9009\u62E9\u3002") : null) : null) : null, !isVideo2 && activePreset ? /* @__PURE__ */ import_react.default.createElement("section", { className: "generation-section generation-prompt-section" }, /* @__PURE__ */ import_react.default.createElement(TextField, { label: "\u63D0\u793A\u8BCD", multiline: true, onChange: (value) => {
...
function Workbench({ externalStructureTrigger = false } = {}) {
  ...
  const frameGenerationCandidates = (target) => {
    ...
    add("\u955C\u5934\u4E13\u5C5E\u53C2\u8003\u56FE", "\u955C\u5934", selectedShotReferenceSlot ? selectedSlotVisual(selectedShotReferenceSlot) : void 0, "referenceImage");
    add("\u955C\u5934\u5019\u9009\u56FE", "\u955C\u5934", selectedShotCandidateSlot ? selectedSlotVisual(selectedShotCandidateSlot) : void 0, "referenceImage");
    add(activeScene?.sceneId || selectedAsset.design.sceneId, "\u573A\u6B21", activeScene?.scene ? selectedVisualFromAsset(activeScene.scene, ["setting", "reference", "firstFrame", "lastFrame"]) : void 0, "sceneReference");
    for (const location of effectiveLocationAssetsForSelectedShot) {
  ...
  const sceneAssetGenerationCandidates = (targetAsset) => {
    ...
    const addLocation = (location) => add(
      location.name,
      "\u573A\u666F",
    ...
    const addCharacter = (character) => {
      ...
      for (const look of character.looks) {
        add(`${character.name} \xB7 ${look.name}`, "\u4EBA\u7269", selectedVisualFromAsset(look, ["reference", "turnaround", "costume"]), "characterReference");
      }
    };
    const addProp = (prop) => add(
      prop.name,
      "\u9053\u5177",
